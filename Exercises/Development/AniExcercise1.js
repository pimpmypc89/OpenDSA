...
(function() {
    ...
    var aniExcercise1 = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    aniExcercise1.userInput = false;
	    av = new JSAV("AniExcercise1", {animationMode: "none"});
	...
	aniExcercise1.userInput = true;
    }
    // Export name used here
    window.aniExcercise1 = window.aniExcercise1 || aniExcercise1;
}());
