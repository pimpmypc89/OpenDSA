...
(function() {
	...
	maxValue: function() {
	    ...
	    AniExcercise3.option[0] = my_array[1];
	    AniExcercise3.option[1] = my_array[2];
	    AniExcercise3.option[2] = my_array[3];
	    return my_array[0];
	},

    };

    window.AniExcercise3 = window.AniExcercise3 || AniExcercise3;
}());
